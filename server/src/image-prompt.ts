...
const OLLAMA_URL_ENV = process.env['OLLAMA_IMAGE_URL'] ?? process.env['OLLAMA_URL'] ?? 'http://host.docker.internal:11434'
...
export function imageModelUrl(): string { return boxUrl(OLLAMA_URL_ENV) }
